...
class NeruBlockEntityRenderer(ctx: BlockEntityRendererProvider.Context) :
    ...
    companion object {
        private val TEXTURE = Identifier("textures/obj/neru.png")
        private val SQUISHED_TEXTURE = Identifier("textures/obj/neru_squished.png")
    }

    private val obj = OBJParser(Identifier("models/obj/neru.obj")).quads().ignoreMtl().parse()
